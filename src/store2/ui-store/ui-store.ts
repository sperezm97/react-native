...
import { Chat, ChatModel } from 'store2/chats-store'
...
export const UiStoreModel = types
  ...
  .props({
    ...
    subModalParams: types.optional(types.map(types.frozen()), null),
    redeemModalParams: types.optional(types.map(types.frozen()), null),
    contactSubscribeModal: false,
    contactSubscribeParams: types.maybe(types.reference(ContactModel)),
    newTribeModal: false,
    newGroupModal: false,
    editTribeParams: types.optional(types.map(types.frozen()), null),
    shareTribeUUID: types.optional(types.string, null),
    groupModal: false,
    ...
    rawInvoiceModalParams: types.optional(types.map(types.frozen()), null),
    lastPaidInvoice: '',
    joinTribeParams: types.optional(types.map(types.frozen()), null),
    imgViewerParams: types.optional(types.map(types.frozen()), null),
    vidViewerParams: types.optional(types.map(types.frozen()), null),
    rtcParams: types.optional(types.map(types.frozen()), null),
    jitsiMeet: false,
    ...
    showBots: false,
    startJitsiParams: types.optional(types.map(types.frozen()), null),
    showProfile: false,
    onchain: false,
    newContact: types.optional(types.map(types.frozen()), null),
    viewTribe: types.optional(types.map(types.frozen()), null),
    tribeText: types.optional(types.map(types.frozen()), {}),
    addSatsModal: false,
    showVersionDialog: false,
    paymentRequest: false,
    pinCodeModal: false,
    signedUp: false,
    podcastBoostAmount: types.optional(types.number, null),
  })
