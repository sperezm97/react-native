...
export class ChatStore {
  ...
  async joinDefaultTribe() {
    const params = await this.getTribeDetails(DEFAULT_TRIBE_SERVER, 'X3IWAiAW5vNrtOX5TLEJzqNWWr3rrUaXUwaqsfUXRMGNF7IWOHroTGbD4Gn2_rFuRZcsER0tZkrLw3sMnzj4RFAk_sx0')
