...
export const ErrorSimple = (props: any) => {
  return (
    <View style={CONTAINER}>
      ...
      <Text style={FRIENDLY_SUBTITLE}>The issue has been reported to developers. Please try again later.</Text>
      <Text style={FRIENDLY_SUBTITLE}>You may be able to get around the error by closing and reopening your app.</Text>
