    ...
    <DrawerContentScrollView {...props} style={{ ...props.style, backgroundColor: theme.main }}>
      <View style={{ height: height - 52, ...styles.wrap }}>
        <View style={styles.drawerContent}>
          <View style={styles.userInfoSection}>
            <View style={styles.userName}>
              <Image resizeMode='cover' source={hasImg ? { uri } : require('../../../android_assets/avatar.png')} style={{ width: 50, height: 50, borderRadius: 25 }} />
            ...
            <View style={{ marginLeft: 60, marginTop: 12 }}>
              <TouchableOpacity style={{ ...styles.addSats, backgroundColor: theme.primary }} onPress={() => ui.setAddSatsModal(true)}>
        ...
        <Drawer.Section style={styles.drawerSection}>
          <DrawerItem
            style={itemStyle}
            icon={({ color, size }) => <AntDesign name='message1' color={theme.title} size={size} />}
            label='Dashboard'
          ...
          <DrawerItem
            style={itemStyle}
            icon={({ color, size }) => <MaterialCommunityIcons name='account-multiple' color={theme.title} size={size} />}
            label='Contacts'
          ...
          <DrawerItem
            style={itemStyle}
            icon={({ color, size }) => <MaterialCommunityIcons name='account' color={theme.title} size={size} />}
            label='Profile'
        ...
        <View style={styles.versionWrap}>
          <Text style={{ ...styles.versionWrap, color: theme.title }}>{`Version: ${VERSION}`}</Text>
        </View>
        <View style={styles.supportWrap}>
          <Button style={styles.supportButton} icon='email' accessibilityLabel='menu-support' onPress={openSupportModalHandler}>
            Support
          </Button>
        </View>
      </View>
