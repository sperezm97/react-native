...
const isLinkWithStart = (textToStart: string) => (link: Link) =>
  link.href.startsWith(textToStart);

const youtubeRegex =
  /(?:youtube\.com\/\S*(?:(?:\/e(?:mbed))?\/|watch\?(?:\S*?&?v\=))|youtu\.be\/)([a-zA-Z0-9_-]{6,11})/;

export const getRumbleLink = getLink(
  isLinkWithStart("https://rumble.com/embed/")
);
