...
import { Image as FastImage, StyleSheet, View, ActivityIndicator, TouchableOpacity } from 'react-native'
...
function Media(props) {
  ...
  let { data, loading, trigger, paidMessageText } = useCachedEncryptedFile(props, ldat)
  ...
  const hasImgData = data ? true : false
    ...
    <>
      {hasImgData && (
        <View style={{ ...styles.wrap }}>
          ...
          {/* ?? */}
          {!loading ? <MediaType type={media_type} data={data} uri='' /> : <ActivityIndicator animating={true} />}
