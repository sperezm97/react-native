...
export default function Msg(props) {
  ...
  return (
    <MsgRow showInfoBar={props.showInfoBar} isJoinMsg={isJoinMsg}>
      {!isJoinMsg && <Avatar alias={props.senderAlias} photo={props.senderPic} hide={!props.showInfoBar || isMe} />}
      <InnerBox>
        ...
        <BubbleWrap
          ...
          style={{
            ...
            justifyContent: isJoinMsg && 'center',
          }}
        >
          ...
          {!joinMessage.includes(props.type) && (
            <MoreVertButton
...
function DeletedMessage(props) {
  const isMe = props.sender === props.myid
  return (
    <DeletedMsgRow style={{ flexDirection: isMe ? 'row-reverse' : 'row' }}>
