  ...
  return (
    <Wrap>
      ...
      {isTribeOwner && (
        <Buttons>
          {loading === 'approved' ? (
            <CircularProgress style={{ height: 15, width: 15, marginRight: 10 }} />
          ) : (
            <ApproveButton onClick={() => press('approved')} disabled={typ === 'member_reject'}>
          ...
          {loading === 'rejected' ? (
            ...
            <RejectButton onClick={() => press('rejected')} disabled={typ === 'member_approve'}>
