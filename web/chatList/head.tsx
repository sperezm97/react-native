      ...
      {snap ? (
        ...
        <Top style={{ overflow: "hidden" }}>
          <Tooltip title="Refresh" placement="right">
            <CachedButton
              style={{ cursor: "pointer", marginLeft: 20, marginRight: 20 }}
          ...
          >
            ...
            <img src={whiteBitcoinIcon} style={{ height: 15, width: 15 }} />
          </div>
          <Tooltip
            title={ui.connected ? "Connected" : "Not Connected"}
            placement="left"
          >
            {refreshing ? (
              <CircularProgress
                size={18}
                style={{ marginRight: 20, marginLeft: -20, color: "white" }}
              />
            ) : (
              <FlashOnButton
                style={{
