...
export default function ViewContact() {
  ...
  return (
    ...
    >
      <Content bg={theme.bg}>
        {contact.photo_url ? (
          <ImageWrapper src={contact.photo_url}></ImageWrapper>
        ) : (
          <InitialsWrapper style={{ backgroundColor: useAvatarColor(contact.alias) }}>{initial}</InitialsWrapper>
        )}
        <AliasFieldWrapper>
          <TextField
            id='alias'
            ...
            onClick={() => {
              navigator.clipboard.writeText(contact.alias), onCopy('Nickname')
            }}
          />
        </AliasFieldWrapper>
        <PubkeyFieldWrapper>
          <TextField
            ...
            onClick={() => {
              navigator.clipboard.writeText(contact.public_key), onCopy('Address')
            }}
          />
        </PubkeyFieldWrapper>
