...
// import { PersonParams } from 'store/ui'
...
//   if (already) {
//     return (
//       <Modal disableAutoFocus={true} open={true} onClose={onClose} className='view-img-modal-wrap'>
...
//           />
//         </TextareaWrap>
//         {price_to_meet && <H3>{`Price to Meet: ${price_to_meet} sats`}</H3>}
//         <ButtonsWrap>
...
//   return (
//     <ImgWrap>
//       {img ? <Img src={img} /> : <FaceIcon style={{ fontSize: 96, color: '#6681fe', marginBottom: 20 }} />}
//     </ImgWrap>
//   )
// }
