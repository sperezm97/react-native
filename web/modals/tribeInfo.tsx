...
//         <Image style={{ backgroundImage: `url(${tribeParams.img || tentIcon})` }}></Image>
...
//           </Button>
//           <Button disabled={loading} onClick={exitGroup} color={'primary'} style={{ marginTop: 20 }}>
...
//             <Button color={'primary'} onClick={() => setExit(false)}>
//               Cancel
//             </Button>
//             <Button color={'secondary'} onClick={() => actuallyExitGroup()}>
//               Yes
//             </Button>
//           </DialogContent>
//         </Dialog>
