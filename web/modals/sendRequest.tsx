...
export default function SendRequest() {
  const { ui, msg, details, contacts, user } = useStores()
  ...
  if (mode) {
    return (
      <Modal open={true} onClose={sendRequestModalHandler} className='view-img-modal-wrap'>
        <RequestContent bg={theme.bg}>
          ...
          <TextInputWrapper>
            <TextField id='memo' label='Memo' multiline rowsMax={4} value={inputMsg} onChange={onChangeMemoHandler} />
          </TextInputWrapper>
