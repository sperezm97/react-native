...
import { transformPayments } from 'components/utils/payments/transformPayments'

const { useTribes } = hooks

// console.log('APPCONSTANTS:', appConstants)
// const conversation = appConstants.chat_types.conversation
...
export const ChatHeader = observer(
  ({ chat, status, tribeParams, podId, pricePerMinute }: HeaderProps) => {
    ...
    const [spentInMessagesBoost] = useMemo(
      ...
      [payments && payments.length, user.myid, chats]
    )
